...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Trending Boss",
    ownernumber: process.env.Owner_Number || "233557560911",
    instagramId: process.env.Insta || "trendingboss_",

    /**
     * other details and parameters
     */
    author: process.env.Author || "Trending Boss 🌚🌙",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://trending1:trending1@cluster0.a0u3f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "emNxZmE_AN_YA_zZDA=",
